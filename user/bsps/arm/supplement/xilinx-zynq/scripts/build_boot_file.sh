...
function print_help {
  echo "Please call this script using ./build_boot_file.sh -b <full_path_to_bit_file> -f <full_path_to_fsbl_file> -a <full_path_to_app_file> -o <full_path_to_output_folder>"
